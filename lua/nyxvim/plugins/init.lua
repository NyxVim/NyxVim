return {
...

  {
    ...
    opts = function()
      ...
      return { override = require "nyxvim.icons.devicons" }
    end,
  },
  ...
  -- file managing , picker etc
  {
    ...
    opts = function()
      return require "nyxvim.configs.nvimtree"
    end,
  },
  ...
  -- git stuff
  {
    ...
    event = "User FilePost",
    opts = function()
      return require "nyxvim.configs.gitsigns"
    end,
  },
  ...
  -- lsp stuff
  {
    ...
    opts = function()
      return require "nyxvim.configs.mason"
    end,
    config = function(_, opts)
      if opts.ensure_installed then
        vim.api.nvim_echo({
          { "\n   ensure_installed has been removed! use M.mason.pkgs table in your nyxrc.\n", "WarningMsg" },
          { "   https://github.com/NyxVim/ui/blob/main/lua/nyxconfig.lua#L85 \n\n", "FloatBorder" },
          {
          ...
          { "   So dont add them in your nyxrc as MasonInstallAll automatically installs them! \n", "Changed" },
        }, false, {})
      end
  ...
  -- load luasnips + cmp related in insert mode only
  {
    ...
    opts = function()
      return require "nyxvim.configs.cmp"
    end,
  },
...

  {
    ...
    build = ":TSUpdate",
    opts = function()
      return require "nyxvim.configs.treesitter"
    end,
    config = function(_, opts)
